...
function showTodos() {
    ...
    todos.forEach((item, i) => {
        listGroupTodo.innerHTML +=
            `
                <li class="list-group-item d-flex justify-content-between ${item.completed == true ? 'completed' : ''}" ondblclick=setCompleted(${i})>
                    ${item.text}
...
function showMessage(where, message) {
    ...
    setTimeout((() => messageCreate.textContent = ''), 2500)
}
...
formCreate.addEventListener('submit', (e) => {
    ...
    if (todoText.length) {
        ...
        showMessage('message-create', 'Please, enter your todo text...')
    }
})
...
formEdit.addEventListener('submit', (e) => {
    ...
    if (todoText.length) {
        ...
        showMessage('message-edit', 'Please, enter your todo text...')
    }
})
